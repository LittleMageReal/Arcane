...
{
    //Script for sphere attack. Script make Sphere rotate around object. Every second sphere rotate it go further, when rotation stops sphere returns
    ...
    // Hold attack to make radius bigger and change rotation when middle mouse presed 
    // Just checking all inputs possibilities
    void Update()
    {
